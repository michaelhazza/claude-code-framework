...
| `.claude/agents/bug-fixer.md#rules` | directives under this heading | process-contract | file classified at file-level default (not per-directive extracted this pass) — spot-check candidate; never-auto-finalise gate and 2-attempt check cap noted |
...
| `.claude/agents/regression-scribe.md#step-4-open-the-review-gated-pr` | directives under this heading | process-contract | file classified at file-level default (not per-directive extracted this pass) — spot-check candidate |
...
| `.claude/agents/regression-scribe.md#rules` | directives under this heading | process-contract | file classified at file-level default (not per-directive extracted this pass) — spot-check candidate |
