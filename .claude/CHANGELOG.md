...
**Fixed:** sub-agent dispatch of the OpenAI review tier no longer deadlocks or returns prematurely on directional forks or at finalisation when no interactive operator is present.
